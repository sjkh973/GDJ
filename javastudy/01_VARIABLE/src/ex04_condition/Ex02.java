...
public class Ex02 {
	...
	public static void main(String[] args) {
		 ...
		 * 논리 NOT : !, true는 false/false는 true로 바꿔줌 
		 * 
		 */
		...
		//연습
		//변수 n을 10증가 시킨 뒤 100보다 크다면 true 아니면 false
		int n = 95;
		...
		System.out.println(j); //10 &&면 앞에 값이 false일때 진행하지않음 어차피 false니까
		
		boolean result10 = (i == 10) || (++j == 11);
		System.out.println(result10);
		System.out.println(j); //10 ||면 앞에 값이 true일때 진행하지않음 어차피 true니까
